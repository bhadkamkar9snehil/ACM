...
Signature: `write_sensor_correlations_from_raw(self, raw_score: Optional[pd.DataFrame])`

Summary: Build sensor correlation matrix from raw sensor frame and persist it.
