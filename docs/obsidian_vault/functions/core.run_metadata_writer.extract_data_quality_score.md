...
Signature: `extract_data_quality_score(sql_client: Any, run_id: str, equip_id: int)`

Summary: Extract overall data quality score from ACM_DataQuality (SQL-only runtime).
