...
Signature: `write_seasonal_patterns_from_detected(self, seasonal_patterns: Optional[Dict[str, List[Any]]])`

Summary: Flatten detected seasonal patterns and persist them to SQL.
