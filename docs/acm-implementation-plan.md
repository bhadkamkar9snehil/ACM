...
(docs/acm-factory.md) are live. The S0 work is filed as briefs on the Hermes
...
docs/acm-factory.md. This section is the model; that document is the floor
plan.
